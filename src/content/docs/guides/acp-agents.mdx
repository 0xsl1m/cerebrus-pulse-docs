...
|------|-------|--------|---------|----------|
| **Lite** | $0.25 | 1 model | 60s | Quick answers, simple queries |
| **Standard** | $0.75 | 3 models | 90s | Balanced analysis with multiple perspectives |
| **Premium** | $2.50 | 5+ models | 300s | Deep synthesis with adversarial deliberation |
...
| **Payment** | USDC on Base or Solana (micropayments) | VIRTUAL token (escrow) |
...
For agent-to-agent connections using Google's A2A protocol, see the [A2A Protocol Guide](/guides/a2a-agents).

See the full comparison at [x402 vs A2A vs ACP](/reference/x402-vs-acp).
