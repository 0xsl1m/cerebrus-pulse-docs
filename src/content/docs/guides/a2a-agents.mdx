...
Cerebrus Pulse implements [Google's A2A protocol](https://github.com/google/a2a-spec) (v0.3), an open standard for agent-to-agent communication governed by the Linux Foundation. Payments are handled via x402 USDC micropayments on Base.
...
3. **Pay** — Your agent signs a USDC micropayment on Base using the x402 SDK
